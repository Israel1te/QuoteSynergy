      ...
      <div style={styles.container}>
        <div style={styles.titleContainer}>
          ...
          <h4 style={styles.subtitle}>
            Hand selected with care by our site's administrators!
          </h4>
          <h4 style={styles.subtitle}>
            ~New videos and podcasts updated every week~
          </h4>
        </div>
        ...
        {selectedPodcast && (
          <div
            style={{
              ...styles.selectedPodcastContainer,
              opacity: isPodcastVisible ? 1 : 0,
            }}
          >
            <button style={styles.closeButton} onClick={handleClosePodcast}>
              X
            </button>
            <div
              dangerouslySetInnerHTML={{ __html: selectedPodcast.embedCode }}
            />
          </div>
        )}
