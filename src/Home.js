...
>>>>>>> 570916c (FAQ and copyright section added. Small adjustments to layout of home page added.)
          <div className="feature-card">
            <div className="card-title">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <section className="faq-section">
        <div className="faq-container">
          ...
          <details>
            ...
            <div className="faq-answer">
              <p>
                The accuracy of the recommendations depends on various factors,
                including the specificity of the input provided and the
                effectiveness of the AI algorithm. We continuously strive to
                improve the accuracy and relevance of our recommendations based
                on user feedback and algorithmic enhancements.
              </p>
            </div>
          </details>
          <details>
          ...
          <details>
            ...
            <div className="faq-answer">
              <p>
                There is no limit to the number of quotes you can generate using
                our AI quote generator. Feel free to use it as often as you'd
                like to discover new inspiration and insights tailored to your
                preferences.
              </p>
            </div>
          </details>
          ...
          <details>
            <summary>
              How can I get started with the AI quote generator?
            </summary>
            <div className="faq-answer">
              <p>
                Getting started is easy! Simply visit our website and begin by
                describing the type of quote you're looking for. Follow the
                prompts to customize your preferences, explore the curated
                recommendations, and embrace the power of personalized
                inspiration.
              </p>
            </div>
          </details>
